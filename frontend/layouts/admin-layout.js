...
const pages = [
	{label: "Pet Registration", url: "/admin/pet-registration"},
	{label: "Vaccination", url: "/super-admin/vaccination-centers"},
	{label: "Manage Staff", url: "/super-admin/inventory"},
	{label: "Requests", url: "/super-admin/inventory"},
	{label: "Manage Appointments", url: "/super-admin/inventory"},
];
