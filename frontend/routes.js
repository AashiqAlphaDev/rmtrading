...
routes.add('/book-appointment/:center_id/:date/:queue_name/:slot_index','/book-appointment');
...
routes.add('/super-admin-dashboard/app-data/pet-type/manage-breeds/:pet_type_id','/super-admin-dashboard/app-data/pet-type/manage-breeds');
