...
const Index = withRoot((theme)=>{
	...
	<Container className={classes.body}>
		...
		<Typography variant={"subheading"}>Recomended Collections</Typography>
		<Typography variant={"subheading"}>Featured</Typography>
	</Container>
))

export default (AdminLayoutWrapper(connect(store => store)(Index), {url:"/super-admin/collections"}))