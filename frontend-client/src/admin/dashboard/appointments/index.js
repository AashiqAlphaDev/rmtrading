...
import {
    Avatar,
    Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Divider, IconButton, ListItem,
...
import {AppointmentsIcon, PetsIcon} from "../../../components/icons";
    ...
    render(){
        ...
        if (this.props.entities.vaccination_center.centers._id){
            return <Layout direction={"column"} flex={1} className={classes.body}>
                ...
                <Paper className={`${classes.paper} ${classes.sidePanel} ${classes.paperPage} flex`} elevation={0}>
                ...
                <Paper className={`${classes.paperPage} ${classes.paper} ${classes.sidePanel}`} elevation={0}>
                    <Layout direction={"column"} alignItems={"center"} flex={1}>
                        ...
                        <Layout>
                            <Select className={`flex`} value={this.props.entities.vaccination_center.centers.appointments_per_hour}
                            ...
                            <DialogContent>
                                ...
                                <DialogContentText>
                                    <Typography gutterBottom>
                                        Add a queue to vet-center list to manage appointments of the newly added queue
                                    </Typography>
                                </DialogContentText>
